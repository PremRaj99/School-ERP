...
import { CreateTeacherAttendanceSchema, dateSchema, monthSchema, teacherIdSchema, UpdateTeacherAttendanceSchema } from "../types";
import { AdminTeacherAttendanceService } from "../services/teacherAttendance.service";

export const getTeacherAttendanceForDate = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const getTeacherAttendanceForMonth = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const markTeacherAttendanceForDate = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const date = validateSchema(dateSchema, String(req.query.date));
...
export const updateTeacherAttendanceForDate = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
