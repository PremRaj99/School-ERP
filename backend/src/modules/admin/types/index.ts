...
// Teacher
export const teacherIdSchema = z.string({ message: "teacherId is required" }).regex(/^TCH\d{8}$/, "Invalid Teacher ID.");

export const CreateTeacherSchema = z.object({
  firstName: z.string({ message: "First name is required." }).min(2, "First name must be at least 2 characters long."),
  ...
  salaryPerMonth: z.number({ message: "Salary is required." }).positive("Salary must be a positive number."),
  qualifications: z.string({ message: "Qualifications are required." }).min(2, "Qualifications must be at least 2 characters long."),
...
// Student
export const studentIdSchema = z.string({ message: "studentId is required" }).regex(/^STU\d{8}$/, "Invalid Student ID.");
...
export const CreateStudentSchema = z.object({
  ...
  rollNo: z.number({ message: "Roll No is required." }).positive("Roll No must be a positive number."),
